...
export default function Page() {
    ...
    return (
        <main className="micro-page">
            ...
            <p><strong>Direct Parent :</strong> {metadata.directParentComponent}</p>
            <p><strong>Owner's Level :</strong> {metadata.ownersLevel}</p>
            <p><strong>Functional Goal :</strong> {metadata.functionalGoal}</p>
